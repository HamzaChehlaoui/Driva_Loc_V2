        ...
        <div class="bg-black p-8 rounded-lg shadow-lg max-w-sm w-full">
            <form action="addtheme.php">
                <div class="mb-4">
                    ...
                    <input id="name" name="name_theme" type="text" class="mt-2 p-2 w-full border border-gray-700 rounded-md focus:ring-2 focus:ring-gray-500 text-white bg-gray-800" placeholder="Enter theme name">
                </div>
